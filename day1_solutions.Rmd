...
1. Write code to create a vector with 5 ones and display it.
...
2. Write code to create the vector `r c(1, 2, 3, 1, 2, 3, 1, 2, 3)` without having to specify all individual elements.
...
3. Write code to create the vector `r c(1, 1, 1, 2, 2, 2, 3, 3, 3)` without having to specify all individual elements. Use ?rep for help.
